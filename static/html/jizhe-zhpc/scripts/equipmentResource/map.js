...
define(function(require) {
  ...
  //var path = 'http://12.68.0.170:8083/jizhenpc/data'
  ...
  var map = {
    ...
    init: function(masterFile, data, type, mapurl, caseNumberUrl){
      ...
      _common.mapInit(masterFile, data, config, type, '#equipmentResourceMap', mapurl, caseNumberUrl, '设备数量')    
    },
    ...
    victory: function(data){
      _common.victory(data, config, '#equipmentResourceMap', '#equipmentResourceVictory', 0)         
    }
